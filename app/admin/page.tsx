...
setEnrollments(enrollments.filter(s=>s._id !== id));
...
<Link href="/admin" className="hover:bg-[#ffb000] hover:text-black px-4 py-2 rounded">
Dashboard
</Link>

<Link href="/admin/enrollments" className="bg-[#ffb000] text-black px-4 py-2 rounded font-semibold">
Enrollments
</Link>

<Link href="/admin/students" className="hover:bg-[#ffb000] hover:text-black px-4 py-2 rounded">
Students
</Link>

<Link href="/admin/courses" className="hover:bg-[#ffb000] hover:text-black px-4 py-2 rounded">
Courses
</Link>
...
const totalPaid = student.installments?.reduce(
